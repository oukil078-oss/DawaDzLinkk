...
interface PharmacyRegistrationStep1Props {
  onNext: (data: PharmacyStep1Data) => void;
  onBack: () => void;
  onGoToLogin?: () => void;
}

export interface PharmacyStep1Data {
  pharmacyName: string;
...
export function PharmacyRegistrationStep1({ onNext, onBack, onGoToLogin }: PharmacyRegistrationStep1Props) {
  const [formData, setFormData] = useState<PharmacyStep1Data>({
    pharmacyName: '',
    agreementNumber: '',
    email: '',
    phone: '',
  ...
  const updateField = (field: keyof PharmacyStep1Data, value: string) => {
      ...
      <div className="flex-1 pt-12 pb-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
            <h2 className="text-xl text-gray-900 mb-6">Inscription Pharmacie</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) => updateField('agreementNumber', e.target.value)}
                  placeholder="AG789012"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg text-base placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                  required
                />
              </div>
