...
export function EditAgentModal({ agent, onClose, onUpdate }: EditAgentModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 animate-fadeIn">
      <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-scale-in">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h3 className="text-xl font-semibold text-gray-900">Modifier l'agent commercial</h3>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label className="block mb-2 text-sm font-medium text-gray-700">Région *</label>
            <select
              required
          ...
          <div className="pt-4 border-t border-gray-200">
            <h4 className="mb-4 font-medium text-gray-900">Réseaux sociaux (optionnel)</h4>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block mb-2 text-sm font-medium text-gray-700">Facebook (username)</label>
                <input
                  type="text"
